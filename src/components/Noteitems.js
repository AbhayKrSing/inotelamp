...
export default function Noteitems(props) {
    ...
    return (
        <div className="col-4 my-1">
            ...
            <i className="fa-sharp fa-solid fa-trash position-absolute position-absolute top-0 end-0 mx-2 mt-3" onClick={alertEvent}></i>
            <i className="fa-solid fa-pen-to-square position-absolute position-absolute top-0 end-0 mx-5 mt-3" onClick={alertEvent}></i>
